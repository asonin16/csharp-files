...
class Program
{
    static void Main(string[] args)
    {
        ...
        */
        ...
        var cashTill = new int[] { 0, 0, 0, 0 };
        int registerCheckTillTotal = 0;

        // registerDailyStartingCash: $1 x 50, $5 x 20, $10 x 10, $20 x 5 => ($350 total)
        var registerDailyStartingCash = new int[,] { { 1, 50 }, { 5, 20 }, { 10, 10 }, { 20, 5 } };

        var testData = new int[] { 6, 10, 17, 20, 31, 36, 40, 41 };
        int testCounter = 0;
